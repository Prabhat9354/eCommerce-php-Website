    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Begin -->
        ...
        <div class="panel-body"><!-- panel-body 1 Begin -->
            <div class="input-group"><!-- input-group Begin -->
                <input type="text" class="form-control" id="eStore-table-filter" data-filters="#eStore-manufacturer" data-action="filter" placeholder="Filter Manufacturer">
        ...
        <div class="panel-body scroll-menu"><!-- panel-body 2 Begin -->
            <ul class="nav nav-pills nav-stacked category-menu" id="eStore-manufacturer"><!-- nav nav-pills nav-stacked category-menu Begin -->
...
<div class="panel panel-default sidebar-menu"><!-- panel panel-default sidebar-menu Begin -->
    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Begin -->
        ...
        <div class="panel-body"><!-- panel-body 1 Begin -->
            <div class="input-group"><!-- input-group Begin -->
                <input type="text" class="form-control" id="eStore-table-filter" data-filters="#eStore-cat" data-action="filter" placeholder="Filter Categories">
        ...
        <div class="panel-body scroll-menu"><!-- panel-body 2 Begin -->
            <ul class="nav nav-pills nav-stacked category-menu" id="eStore-cat"><!-- nav nav-pills nav-stacked category-menu Begin -->
...
<div class="panel panel-default sidebar-menu"><!-- panel panel-default sidebar-menu Begin -->
    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Begin -->
        ...
        <div class="panel-body"><!-- panel-body 1 Begin -->
            <div class="input-group"><!-- input-group Begin -->
                <input type="text" class="form-control" id="eStore-table-filter" data-filters="#eStore-p-cat" data-action="filter" placeholder="Filter Product Categories">
        ...
        <div class="panel-body scroll-menu"><!-- panel-body 2 Begin -->
            <ul class="nav nav-pills nav-stacked category-menu" id="eStore-p-cat"><!-- nav nav-pills nav-stacked category-menu Begin -->
